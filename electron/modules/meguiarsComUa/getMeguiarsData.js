        ...
        let pagePromise = (link, id) =>
          new Promise(async (resolve, reject) => {
            ...
            if (isFirstPriceSelector) {
              dataObj["goodPrice"] = await newPage.$eval(".container .price", (text) =>
            ...
            if (isFirstBrandSelector) {
              ...
              let goodStatus =
                topTableElements[topTableElements.length - 1].trim();
            ...
            if (isSpecificationSelector) {
              ...
              tableElements.forEach((el, i) => {
                ...
                el === "Объем" &&
                  (dataObj["goodCapacity"] = tableElements[i + 1]);
                el === "Аромат" &&
                  (dataObj["goodAroma"] = tableElements[i + 1]);
                el === "Использование" &&
